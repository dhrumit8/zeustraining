...
const hamburger = document.getElementById("hamburger-menu-logo");
const menubar = document.querySelector(".vertical-menu");
const alertLogo = document.getElementById("alert-logo");
const alertContainer = document.querySelector(".alert-container");
const announcementLogo = document.getElementById("announcement-logo");
